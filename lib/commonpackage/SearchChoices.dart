import 'package:astro_santhil_app/commonpackage/constants.dart';
import 'package:astro_santhil_app/commonpackage/dropdown_dialog.dart';
...
class SearchChoices<T> extends FormField<T> {
  ...
  SearchChoices.single({
    ...
    this.searchResultDisplayFn,
        ...
        super(
        key: key,
        builder: (FormFieldState<dynamic> state) {_SearchChoicesState<T> sCState = state as _SearchChoicesState<T>;
